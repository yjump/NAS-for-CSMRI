...
from models.nas.search_cells import SearchCell
...
class SearchCNN(nn.Module):
    """ Search CNN model """
    def __init__(self, C_in, C, n_classes, n_layers, n_nodes=2, stem_multiplier=1):
        """
        Args:
        ...
        self.linear = nn.Sequential(
            nn.ReLU(),
            nn.Conv2d(C_p, n_classes, 3, 1, 1, bias=False),
            # nn.BatchNorm2d(C_cur)
        )
...
class SearchCNNController(nn.Module):
    ...
    def __init__(self, C_in, C, n_classes, n_layers, criterion, n_nodes=2, stem_multiplier=1,
                 device_ids=None):
        super().__init__()
