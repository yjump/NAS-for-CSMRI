...
from data.transforms import ifftshift, fftshift
...
if __name__ == '__main__':
    ...
    NORM = 'ortho'  # 'ortho'
    seq = sio.loadmat('/vol/medic02/users/js3611/cardiac_mri/jose/cardiac_complex/matlab/res_data_tmi_10_ac4.mat')[
        'seq']
